...
import CacheService from "./class/NodeCache0103"; // cache
import Logger from "./class/Logger"; // logger

// secret info setting
dotenv({ path: path.join(__dirname, "./.env") });
// logger settting
const logger: Logger = new Logger(myDev.COMPANY_NAME, myDev.APP_NAME, undefined, 'debug');
